...
ALTER TABLE university ADD COLUMN IF NOT EXISTS is_985 TINYINT(1) NOT NULL DEFAULT 0;
ALTER TABLE university ADD COLUMN IF NOT EXISTS is_211 TINYINT(1) NOT NULL DEFAULT 0;
ALTER TABLE university ADD COLUMN IF NOT EXISTS is_double_first_class TINYINT(1) NOT NULL DEFAULT 0;
